...
void annotationWidget::loadedfinish(bool value)
{
   ...
   _frame->evaluateJavaScript("changeBackground('"+urlfile+"');");
    ...
    //   qDebug() << QUrl::fromLocalFile("IMG_2617.JPG").toString();


       //_frame->evaluateJavaScript("changeBackground('file:///home/easy/STUFF/C++/widgetdraw/IMG_2617.JPG');");
       //_frame->evaluateJavaScript("canvas.setBackgroundImage('file:///home/easy/STUFF/C++/widgetdraw/IMG_2617.JPG', canvas.renderAll.bind(canvas),  {   backgroundImageStretch: true } );");
       //_frame->evaluateJavaScript("canvas.renderAll();");
}
